...
public class SlidingSwitcherView extends RelativeLayout implements View.OnTouchListener {
    ...
    public SlidingSwitcherView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void refreshDotsLayout() {
        ...
        for (int i = 0; i < itemsCount; i++) {
            ...
            if (i == currentItemIndex) {
                image.setBackgroundResource(R.drawable.ic_dot_selected);
            } else {
                image.setBackgroundResource(R.drawable.ic_dot_unselected);
            }
